  ...
  return (
    <div
      className={`flex h-screen ${
        isShow ? "w-60" : "w-20"
      } flex-col items-center overflow-hidden bg-gray-900 text-gray-400 duration-300`}
    >
      <a className="mt-3 flex w-full items-center px-3" href="#">
        ...
        <span className={`${isShow ? "" : "hidden"} ml-2 text-sm font-bold`}>
          The App
        </span>
      </a>
      <div className="w-full px-2">
        <div className="mt-3 flex w-full flex-col items-center border-t border-gray-700">
          ...
          >
            ...
            <span
              className={`${isShow ? "" : "hidden"} ml-2 text-sm font-medium`}
            >
              Dasboard
            </span>
          </a>
      ...
      >
        ...
        <span className={`${isShow ? "" : "hidden"} ml-2 text-sm font-medium`}>
          Account
        </span>
      </a>
    </div>
